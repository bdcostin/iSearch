  ...
  getSearch(artist)
    .then(function (searchData) {
      ...
      for (let track of searchData.results) {
        ...
        artworkDiv.innerHTML = `<img data-audio-id="audio-id${searchData.results.indexOf(track)}" class="br-100 h3 w3 dib mb2" src="${track.artworkUrl100}" alt="${track.collectionName}">`
